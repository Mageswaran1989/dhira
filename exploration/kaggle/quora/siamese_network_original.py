...
class SiameseLSTMOriginal(object):
    """
    ...
    def __init__(
        ...
        with tf.name_scope("embedding"):
            ...
            self.embedded_chars1 = tf.nn.embedding_lookup(embedding_init, self.input_x1)

            # self.embedded_chars_expanded1 = tf.expand_dims(self.embedded_chars1, -1)
            self.embedded_chars2 = tf.nn.embedding_lookup(embedding_init, self.input_x2)
